                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                           ...
                           <ul class="sub">
                                <li><a href="{{URL::to('/add-brand-product')}}">Thêm thương hiệu sản phẩm 
                                phẩm</a></li>
                                <li><a href="{{URL::to('/all-brand-product')}}">Liệt kê thương hiệu sản phẩm 
                                phẩm</a></li>
                            </ul>
                        </li>
                        <li>
        ...
        $(document).ready(function() {
            ...
            graphArea2 = Morris.Area({
                ...
                data: [{
                    ...
                    {
                        period: '2016 Q3',/-strong/-heart:>:o:-((:-h iphone: 4830,
                        ipad: 3805,
                        itouch: 1598
                    },
                    {
